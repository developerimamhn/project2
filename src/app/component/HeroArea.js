            ...
            <div className="container mx-auto">
                <div className="flex justify-between items-end pt-[20px] sm:pt-[54px] lg:pt-[69px] pb-[60px] sm:pb-[70px] lg:pb-[100px] xl:pb-[120px] 2xl:pb-[141px]  sm:flex-row flex-col-reverse px-[24px] sm:px-[0]">
                    ...
                    <div className="flex-1">
                        ...
                        <p className='bark-pragraph text-[16px] sm:text-[18px] lg:text-[20px] pb-[25] sm:pb-[28px] lg:pb-[32px]'>
                        ...
                        <div id='copy' className='flex justify-between items-center w-fit sm:w-full py-[8px] sm:py-[12px] pr-[12px] pl-[16px] rounded-xl md:rounded-2xl xl:rounded-3xl text-[15px] lg:text-[16px] xl:text-[18px] 2xl:text-[22px]'><input type="text" className='w-full bg-transparent border-none placeholder:text-[#FCFEFF]' placeholder='CJ8oT6dHzyHsXBq6JdhRHiRto3Le96pHyPchqfYdPxhN' /><button title={text} className='copy-styling-items py-[8px] sm:py-[10px] xl:py-[12px] 2xl:py-[14px] px-[14px] sm:px-[16px] xl:px-[22px] 2xl:px-[24px] rounded-lg sm:rounded-xl lg:rounded-[16px] ml-[32px] duration-300  text-[15px] lg:text-[16px] xl:text-[18px] 2xl:text-[22px] xl:leading-[22px] 2xl:leading-[28.6px]' onClick={handleChangeText}>{text}</button></div> 
