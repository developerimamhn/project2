    ...
    return (
        <div className='relative '>
            ...
            <div className="container mx-auto">
                <div className="flex justify-between items-start sm:items-end pt-[20px] sm:pt-[30px] lg:pt-[40px] 2xl:pt-[69px] pb-[60px] sm:pb-[70px] lg:pb-[100px] xl:pb-[120px] 2xl:pb-[141px]  sm:flex-row flex-col-reverse px-[24px] sm:px-[0]">
                    <div className="flex-1 pt-[100px] sm:pt-0">
                        <Image className='w-[90%] pointer-events-none select-none ' src={image4} alt="" />
                    </div>
                    <div className="flex-1">
                        <h1 className='Froggo-headding text-[70px] sm:text-[60px] md:text-[65px] lg:text-[80px] xl:text-[110px] 2xl:text-[156px] uppercase leading-auto xl:leading-[120px] 2xl:leading-[187.2px]'>$Froggo</h1>
                        <p className='bark-pragraph text-[16px] sm:text-[18px] lg:text-[20px] pb-[20px] sm:pb-[25px] lg:pb-[24px] 2xl::pb-[32px] !text-[#FCFEFF] leading-auto xl:leading-[28px] 2xl:leading-[36px]'>
                        ...
                        <div className="flex items-center pt-[52px] flex-col md:flex-row gap-[30px] sm:gap-0">
                            ...
                            <div className="relative flex-1">
                                ...
                                <Image className='animate-contrastEffect pointer-events-none select-none w-screen sm:w-[70%] 2xl:w-auto' src={image6} alt="" />
                            </div>
                        </div>
